...
function vgDelete(vg_delete) {
    $(vg_delete).on('click', function(e){
        if(!confirm('Подтвердить удаление')){
            return false;
        }else if($(this).is(".gal_wrap img.vg_delete") || $(this).is(".main_img > div > img.vg_delete")){
            e.stopPropagation();
...
function delGalleryImg(img){
    ...
    galImg.id = parseInt($(img).closest("form").children("input[type=hidden]").val());
    galImg.table = $(img).closest("form").attr('table');
    let file_name = $(img).closest("div.div_fdc").find("input[type=file]").attr("name");
...
$(document).ready(function($){
    ...
    $('.single_img, .gal_btn').on('change', function(){
        var container;
        var self = this;
        if($(this).is(".single_img")){
            container = $(this).closest(".img_container").find(".img_show");
        }else{
            container = $(this).closest(".gal_wrap").find(".gal_item_free");
        }
        var send_image = this;
